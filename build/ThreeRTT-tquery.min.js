...
ThreeRTT.Camera=function(a){if(a instanceof THREE.Camera)return a;a=_.extend({aspect:1,far:1E4,fov:85,near:.01,ortho:!1,scale:1},a);if(a.ortho){var b=a.scale,e=a.aspect;return new THREE.OrthographicCamera(-b*e,b*e,-b,b,a.near,a.far)}return new THREE.PerspectiveCamera(a.fov,a.aspect,a.near,a.far)};
...
!1;g.depthWrite=!1;g.transparent=!0;g.blending=THREE.NoBlending;return g};ThreeRTT.DownsampleMaterial=function(a,b){return new ThreeRTT.ScaleMaterial(a,b,2)};ThreeRTT.UpsampleMaterial=function(a,b){return new ThreeRTT.ScaleMaterial(a,b,.5)};
