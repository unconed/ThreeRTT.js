(function(){function a(c,k,b){if(c===k)return 0!==c||1/c==1/k;if(null==c||null==k)return c===k;c._chain&&(c=c._wrapped);k._chain&&(k=k._wrapped);if(c.isEqual&&d.isFunction(c.isEqual))return c.isEqual(k);if(k.isEqual&&d.isFunction(k.isEqual))return k.isEqual(c);var q=m.call(c);if(q!=m.call(k))return!1;switch(q){case "[object String]":return c==""+k;case "[object Number]":return c!=+c?k!=+k:0==c?1/c==1/k:c==+k;case "[object Date]":case "[object Boolean]":return+c==+k;case "[object RegExp]":return c.source==
k.source&&c.global==k.global&&c.multiline==k.multiline&&c.ignoreCase==k.ignoreCase}if("object"!=typeof c||"object"!=typeof k)return!1;for(var e=b.length;e--;)if(b[e]==c)return!0;b.push(c);var e=0,f=!0;if("[object Array]"==q){if(e=c.length,f=e==k.length)for(;e--&&(f=e in c==e in k&&a(c[e],k[e],b)););}else{if("constructor"in c!="constructor"in k||c.constructor!=k.constructor)return!1;for(var g in c)if(d.has(c,g)&&(e++,!(f=d.has(k,g)&&a(c[g],k[g],b))))break;if(f){for(g in k)if(d.has(k,g)&&!e--)break;
f=!e}}b.pop();return f}var b=this,e=b._,f={},g=Array.prototype,l=Object.prototype,h=g.slice,s=g.unshift,m=l.toString,u=l.hasOwnProperty,r=g.forEach,C=g.map,D=g.reduce,E=g.reduceRight,F=g.filter,G=g.every,H=g.some,w=g.indexOf,I=g.lastIndexOf,l=Array.isArray,M=Object.keys,x=Function.prototype.bind,d=function(c){return new t(c)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=d),exports._=d):b._=d;d.VERSION="1.3.3";var p=d.each=d.forEach=function(c,
a,b){if(null!=c)if(r&&c.forEach===r)c.forEach(a,b);else if(c.length===+c.length)for(var q=0,e=c.length;q<e&&!(q in c&&a.call(b,c[q],q,c)===f);q++);else for(q in c)if(d.has(c,q)&&a.call(b,c[q],q,c)===f)break};d.map=d.collect=function(c,a,b){var d=[];if(null==c)return d;if(C&&c.map===C)return c.map(a,b);p(c,function(c,e,f){d[d.length]=a.call(b,c,e,f)});c.length===+c.length&&(d.length=c.length);return d};d.reduce=d.foldl=d.inject=function(c,a,b,e){var f=2<arguments.length;null==c&&(c=[]);if(D&&c.reduce===
...
var J=d.some=d.any=function(c,a,b){a||(a=d.identity);var e=!1;if(null==c)return e;if(H&&c.some===H)return c.some(a,b);p(c,function(c,d,g){if(e||(e=a.call(b,c,d,g)))return f});return!!e};d.include=d.contains=function(c,a){var b=!1;return null==c?b:w&&c.indexOf===w?-1!=c.indexOf(a):b=J(c,function(c){return c===a})};d.invoke=function(c,a){var b=h.call(arguments,2);return d.map(c,function(c){return(d.isFunction(a)?a||c:c[a]).apply(c,b)})};d.pluck=function(c,a){return d.map(c,function(c){return c[a]})};
...
return b};d.sortedIndex=function(c,a,b){b||(b=d.identity);for(var e=0,f=c.length;e<f;){var g=e+f>>1;b(c[g])<b(a)?e=g+1:f=g}return e};d.toArray=function(c){return c?d.isArray(c)||d.isArguments(c)?h.call(c):c.toArray&&d.isFunction(c.toArray)?c.toArray():d.values(c):[]};d.size=function(c){return d.isArray(c)?c.length:d.keys(c).length};d.first=d.head=d.take=function(c,a,b){return null==a||b?c[0]:h.call(c,0,a)};d.initial=function(c,a,b){return h.call(c,0,c.length-(null==a||b?1:a))};d.last=function(c,a,
b){return null==a||b?c[c.length-1]:h.call(c,Math.max(c.length-a,0))};d.rest=d.tail=function(c,a,b){return h.call(c,null==a||b?1:a)};d.compact=function(c){return d.filter(c,function(c){return!!c})};d.flatten=function(c,a){return d.reduce(c,function(c,b){if(d.isArray(b))return c.concat(a?b:d.flatten(b));c[c.length]=b;return c},[])};d.without=function(c){return d.difference(c,h.call(arguments,1))};d.uniq=d.unique=function(c,a,b){b=b?d.map(c,b):c;var e=[];3>c.length&&(a=!0);d.reduce(b,function(b,f,L){(a?
d.last(b)===f&&b.length:d.include(b,f))||(b.push(f),e.push(c[L]));return b},[]);return e};d.union=function(){return d.uniq(d.flatten(arguments,!0))};d.intersection=d.intersect=function(c){var a=h.call(arguments,1);return d.filter(d.uniq(c),function(c){return d.every(a,function(a){return 0<=d.indexOf(a,c)})})};d.difference=function(c){var a=d.flatten(h.call(arguments,1),!0);return d.filter(c,function(c){return!d.include(a,c)})};d.zip=function(){for(var c=h.call(arguments),a=d.max(d.pluck(c,"length")),
b=Array(a),e=0;e<a;e++)b[e]=d.pluck(c,""+e);return b};d.indexOf=function(c,a,b){if(null==c)return-1;var e;if(b)return b=d.sortedIndex(c,a),c[b]===a?b:-1;if(w&&c.indexOf===w)return c.indexOf(a);b=0;for(e=c.length;b<e;b++)if(b in c&&c[b]===a)return b;return-1};d.lastIndexOf=function(c,a){if(null==c)return-1;if(I&&c.lastIndexOf===I)return c.lastIndexOf(a);for(var b=c.length;b--;)if(b in c&&c[b]===a)return b;return-1};d.range=function(c,a,b){1>=arguments.length&&(a=c||0,c=0);b=arguments[2]||1;for(var d=
Math.max(Math.ceil((a-c)/b),0),e=0,f=Array(d);e<d;)f[e++]=c,c+=b;return f};var K=function(){};d.bind=function(c,a){var b,e;if(c.bind===x&&x)return x.apply(c,h.call(arguments,1));if(!d.isFunction(c))throw new TypeError;e=h.call(arguments,2);return b=function(){if(!(this instanceof b))return c.apply(a,e.concat(h.call(arguments)));K.prototype=c.prototype;var d=new K,f=c.apply(d,e.concat(h.call(arguments)));return Object(f)===f?f:d}};d.bindAll=function(c){var a=h.call(arguments,1);0==a.length&&(a=d.functions(c));
p(a,function(a){c[a]=d.bind(c[a],c)});return c};d.memoize=function(c,a){var b={};a||(a=d.identity);return function(){var e=a.apply(this,arguments);return d.has(b,e)?b[e]:b[e]=c.apply(this,arguments)}};d.delay=function(c,a){var b=h.call(arguments,2);return setTimeout(function(){return c.apply(null,b)},a)};d.defer=function(c){return d.delay.apply(d,[c,1].concat(h.call(arguments,1)))};d.throttle=function(c,a){var b,e,f,g,h,m,l=d.debounce(function(){h=g=!1},a);return function(){b=this;e=arguments;f||
(f=setTimeout(function(){f=null;h&&c.apply(b,e);l()},a));g?h=!0:m=c.apply(b,e);l();g=!0;return m}};d.debounce=function(c,a,b){var d;return function(){var e=this,f=arguments;b&&!d&&c.apply(e,f);clearTimeout(d);d=setTimeout(function(){d=null;b||c.apply(e,f)},a)}};d.once=function(c){var a=!1,b;return function(){if(a)return b;a=!0;return b=c.apply(this,arguments)}};d.wrap=function(c,a){return function(){var b=[c].concat(h.call(arguments,0));return a.apply(this,b)}};d.compose=function(){var c=arguments;
return function(){for(var a=arguments,b=c.length-1;0<=b;b--)a=[c[b].apply(this,a)];return a[0]}};d.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};d.keys=M||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],e;for(e in a)d.has(a,e)&&(b[b.length]=e);return b};d.values=function(a){return d.map(a,d.identity)};d.functions=d.methods=function(a){var b=[],e;for(e in a)d.isFunction(a[e])&&b.push(e);return b.sort()};d.extend=function(a){p(h.call(arguments,
1),function(b){for(var d in b)a[d]=b[d]});return a};d.pick=function(a){var b={};p(d.flatten(h.call(arguments,1)),function(d){d in a&&(b[d]=a[d])});return b};d.defaults=function(a){p(h.call(arguments,1),function(b){for(var d in b)null==a[d]&&(a[d]=b[d])});return a};d.clone=function(a){return d.isObject(a)?d.isArray(a)?a.slice():d.extend({},a):a};d.tap=function(a,b){b(a);return a};d.isEqual=function(c,b){return a(c,b,[])};d.isEmpty=function(a){if(null==a)return!0;if(d.isArray(a)||d.isString(a))return 0===
...
m.call(a)};d.isFinite=function(a){return d.isNumber(a)&&isFinite(a)};d.isNaN=function(a){return a!==a};d.isBoolean=function(a){return!0===a||!1===a||"[object Boolean]"==m.call(a)};d.isDate=function(a){return"[object Date]"==m.call(a)};d.isRegExp=function(a){return"[object RegExp]"==m.call(a)};d.isNull=function(a){return null===a};d.isUndefined=function(a){return void 0===a};d.has=function(a,b){return u.call(a,b)};d.noConflict=function(){b._=e;return this};d.identity=function(a){return a};d.times=
function(a,b,d){for(var e=0;e<a;e++)b.call(d,e)};d.escape=function(a){return(""+a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;").replace(/\//g,"&#x2F;")};d.result=function(a,b){if(null==a)return null;var e=a[b];return d.isFunction(e)?e.call(a):e};d.mixin=function(a){p(d.functions(a),function(b){N(b,d[b]=a[b])})};var O=0;d.uniqueId=function(a){var b=O++;return a?a+b:b};d.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,
escape:/<%-([\s\S]+?)%>/g};var y=/.^/,v={"\\":"\\","'":"'",r:"\r",n:"\n",t:"\t",u2028:"\u2028",u2029:"\u2029"},z;for(z in v)v[v[z]]=z;var P=/\\|'|\r|\n|\t|\u2028|\u2029/g,Q=/\\(\\|'|r|n|t|u2028|u2029)/g,A=function(a){return a.replace(Q,function(a,b){return v[b]})};d.template=function(a,b,e){e=d.defaults(e||{},d.templateSettings);a="__p+='"+a.replace(P,function(a){return"\\"+v[a]}).replace(e.escape||y,function(a,b){return"'+\n_.escape("+A(b)+")+\n'"}).replace(e.interpolate||y,function(a,b){return"'+\n("+
A(b)+")+\n'"}).replace(e.evaluate||y,function(a,b){return"';\n"+A(b)+"\n;__p+='"})+"';\n";e.variable||(a="with(obj||{}){\n"+a+"}\n");a="var __p='';var print=function(){__p+=Array.prototype.join.call(arguments, '')};\n"+a+"return __p;\n";var f=new Function(e.variable||"obj","_",a);if(b)return f(b,d);b=function(a){return f.call(this,a,d)};b.source="function("+(e.variable||"obj")+"){\n"+a+"}";return b};d.chain=function(a){return d(a).chain()};var t=function(a){this._wrapped=a};d.prototype=t.prototype;
var B=function(a,b){return b?d(a).chain():a},N=function(a,b){t.prototype[a]=function(){var a=h.call(arguments);s.call(a,this._wrapped);return B(b.apply(d,a),this._chain)}};d.mixin(d);p("pop push reverse shift sort splice unshift".split(" "),function(a){var b=g[a];t.prototype[a]=function(){var d=this._wrapped;b.apply(d,arguments);var e=d.length;"shift"!=a&&"splice"!=a||0!==e||delete d[0];return B(d,this._chain)}});p(["concat","join","slice"],function(a){var b=g[a];t.prototype[a]=function(){return B(b.apply(this._wrapped,
arguments),this._chain)}});t.prototype.chain=function(){this._chain=!0;return this};t.prototype.value=function(){return this._wrapped}}).call(this);var MicroEvent=function(){};
...
ThreeRTT.Stage.prototype={options:function(){return this.target.options},reset:function(){this.scenes=[];this.passes=[]},paint:function(a,b){var e=new THREE.Scene;if(!b){var f=new ThreeRTT.FragmentMaterial(this,"generic-fragment-texture"),f=this._surface(f);e.add(f)}e.add(a);this.scenes.push(e);this.passes.push(1)},iterate:function(a,b){var e=this._surface(b),f=new THREE.Scene;f.add(e);this.scenes.push(f);this.passes.push(a);return this},fragment:function(a){this.iterate(1,a);return this},size:function(a,
...
[];this.passes=[];this.target=this.camera=null},_surface:function(a){var b=new THREE.Mesh(new ThreeRTT.ScreenGeometry,{});b.frustumCulled=!1;b.material=a;b.renderDepth=Infinity;return b}};ThreeRTT.Compose=function(a,b,e,f){THREE.Object3D.call(this);a=new ThreeRTT.FragmentMaterial(a,b,e,f);b=new ThreeRTT.ScreenGeometry;a=this.mesh=new THREE.Mesh(b,a);a.frustumCulled=!1;this.add(a)};ThreeRTT.Compose.prototype=new THREE.Object3D;
ThreeRTT.Camera=function(a){if(a instanceof THREE.Camera)return a;a=_.extend({aspect:1,far:1E4,fov:85,near:0.01,ortho:!1,scale:1},a);if(a.ortho){var b=a.scale,e=a.aspect;return new THREE.OrthographicCamera(-b*e,b*e,-b,b,a.near,a.far)}return new THREE.PerspectiveCamera(a.fov,a.aspect,a.near,a.far)};
...
b.length,function(){b.push(a.clone())}.bind(this)):b=b.slice(0,n);_.each(b,function(a,b){a.width=this.width;a.height=this.height;a.__index=b}.bind(this));this.virtuals=b;this.index=-1;this.advance()},advance:function(){var a=this.targets,b=this.virtuals,e=this.index,f=this.buffers,g=b.length;this.index=e=(e+1)%f;_.loop(g,function(l){var h=b[l];l=a[(g-l+e)%f];h.__webglTexture=l.__webglTexture;h.__webglFramebuffer=l.__webglFramebuffer;h.__webglRenderbuffer=l.__webglRenderbuffer;h.__index=l.__index})},
clear:function(){var a=this.options,b=a.clear,e=this.renderer,f=e.getClearColor().clone(),g=e.getClearAlpha();e.setClearColor(a.clearColor,a.clearAlpha);e.clearTarget(this.write(),b.color,b.depth,b.stencil);e.setClearColor(f,g)},render:function(a,b){this.emit("render",a,b);var e=this.renderer.autoClear;this.renderer.autoClear=!1;this.clear();this.renderer.render(a,b,this.write());this.renderer.autoClear=e;this.options.autoAdvance&&this.advance()},uniform:function(a){var b=this.history();if(b){var e=
[];_.loop(b+1,function(a){e.push(this.read(-a))}.bind(this));return{type:"tv",value:e,count:b+1}}return{type:"t",value:a,texture:this.read(),count:1}}};MicroEvent.mixin(ThreeRTT.RenderTarget);ThreeRTT.ScreenGeometry=function(){return new THREE.PlaneGeometry(2,2,1,1)};
ThreeRTT.ShaderMaterial=function(a,b,e,f,g){if(f instanceof Array){var l={};_.each(f,function(a,b){l["texture"+(i+1)]=a});f=l}else if(f instanceof THREE.Texture||f instanceof ThreeRTT.World||f instanceof THREE.WebGLRenderTarget)f={texture1:f};a instanceof Array||(a=[a]);a=_.map(a,function(a){return ThreeRTT.toTarget(a)});g=_.extend(g||{},{sampleStep:{type:"v2",value:new THREE.Vector2}});_.each(f,function(a,b){g[b]={type:"t",value:ThreeRTT.toTexture(a)}});_.each(a,function(a,b){var e="texture"+(b+
1);a.read&&!g[e]&&(g[e]={type:"t",value:a.read()})});g.texture1&&!g.texture&&(g.texture=g.texture1);a[0].on("render",function(){var b=a[0].options.texture,e=b.wrapT,f={1E3:0,1001:1,1002:0},l=g.sampleStep.value;l.x=1/(a[0].width-(f[b.wrapS]||0));l.y=1/(a[0].height-(f[e]||0))});return new THREE.ShaderMaterial({uniforms:g,vertexShader:ThreeRTT.getShader(b||"generic-vertex"),fragmentShader:ThreeRTT.getShader(e||"generic-fragment-texture")})};
...
ThreeRTT.ScaleMaterial=function(a,b,e){var f={};a=ThreeRTT.toTarget(a);b=ThreeRTT.toTarget(b);f=_.extend(f,{sampleAlignment:{type:"v2",value:new THREE.Vector2},texture:{type:"t",value:a.read()}});b.on("render",function(){var g=a,h=b,s=h.height*e/g.height,m=f.sampleAlignment.value;m.x=h.width*e/g.width;m.y=s});var g=new THREE.ShaderMaterial({uniforms:f,vertexShader:ThreeRTT.getShader("rtt-vertex-downsample"),fragmentShader:ThreeRTT.getShader("generic-fragment-texture")});g.side=THREE.DoubleSide;g.depthTest=
!1;g.depthWrite=!1;g.transparent=!0;g.blending=THREE.NoBlending;return g};ThreeRTT.DownsampleMaterial=function(a,b){return new ThreeRTT.ScaleMaterial(a,b,2)};ThreeRTT.UpsampleMaterial=function(a,b){return new ThreeRTT.ScaleMaterial(a,b,0.5)};
ThreeRTT.RaytraceMaterial=function(a,b,e,f,g){a instanceof Array||(a=[a]);e=new ThreeRTT.ShaderMaterial(a,"raytrace-vertex-screen",e,f,g);g=_.extend(e.uniforms||{},{raytraceViewport:{type:"v2",value:new THREE.Vector2},raytracePosition:{type:"v3",value:new THREE.Vector3},raytraceMatrix:{type:"m4",value:new THREE.Matrix4}});a=ThreeRTT.toTarget(a[0]);var l=new THREE.Vector3;a.on("render",function(a){b.updateMatrixWorld();b.fov&&(a=Math.tan(b.fov*\u03c0/360),g.raytraceViewport.value.set(a*b.aspect,a));
b.matrixWorld&&(g.raytraceMatrix.value.copy(b.matrixWorld),g.raytraceMatrix.value.setPosition(l),g.raytracePosition.value.getPositionFromMatrix(b.matrixWorld))});return e};ThreeRTT.Display=function(a,b,e){a instanceof Array||(a=[a]);this.gx=b||a.length;this.gy=e||1;this.targets=a;this.n=a.length;THREE.Object3D.call(this);this.make()};
ThreeRTT.Display.prototype=_.extend(new THREE.Object3D,{make:function(){for(var a=this.n,b=this.gx,e=this.gy,f=this.targets,g=(b-1)/2,l=(e-1)/2,h=new THREE.PlaneGeometry(1,1,1,1),s=0,m=0;s<a&&m<e;++m)for(var u=0;s<a&&u<b;++u,++s){var r=new THREE.MeshBasicMaterial({color:16777215,map:ThreeRTT.toTexture(f[s]),fog:!1});r.side=THREE.DoubleSide;r=new THREE.Mesh(h,r);r.renderDepth=1E4+Math.random();this.add(r);1<b&&(r.position.x=-g+u);1<e&&(r.position.y=l-m)}}});
...
return this},shader:function(a,b,e,f){a=a instanceof THREE.Material?a:tQuery.createShaderMaterial(this,a,b,e,f);this._stage.fragment(a);return this},fragment:function(a,b,e){a=a instanceof THREE.Material?a:tQuery.createFragmentMaterial(this,a,b,e);this._stage.fragment(a);return this},raytrace:function(a,b,e,f){a=b instanceof THREE.Material?b:tQuery.createRaytraceMaterial(this,a,b,e,f);this._stage.fragment(a);return this},downsample:function(a){if(!a.autoSize()){var b=a.size();this._options.width=
...
tQuery.registerStatic("createRTT",function(a,b){return new ThreeRTT.World(a,b)});tQuery.registerStatic("createComposeRTT",function(a,b,e,f){return new ThreeRTT.Compose(a,b,e,f)});tQuery.registerStatic("createDisplayRTT",function(a,b,e){return new ThreeRTT.Display(a,b,e)});tQuery.registerStatic("createShaderMaterial",function(a,b,e,f,g){return new ThreeRTT.FragmentMaterial(a,b,e,f,g)});tQuery.registerStatic("createFragmentMaterial",function(a,b,e,f){return new ThreeRTT.FragmentMaterial(a,b,e,f)});
tQuery.registerStatic("createRaytraceMaterial",function(a,b,e,f,g){return new ThreeRTT.RaytraceMaterial(a,b,e,f,g)});tQuery.registerStatic("createDownsampleMaterial",function(a,b){return new ThreeRTT.DownsampleMaterial(a,b)});tQuery.registerStatic("createUpsampleMaterial",function(a,b){return new ThreeRTT.UpsampleMaterial(a,b)});tQuery.registerStatic("createScaleMaterial",function(a,b,e){return new ThreeRTT.DownsampleMaterial(a,b,e)});
