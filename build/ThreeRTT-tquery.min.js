...
d.bind(c[a],c)});return c};d.memoize=function(c,a){var b={};a||(a=d.identity);return function(){var e=a.apply(this,arguments);return d.has(b,e)?b[e]:b[e]=c.apply(this,arguments)}};d.delay=function(c,a){var b=g.call(arguments,2);return setTimeout(function(){return c.apply(null,b)},a)};d.defer=function(c){return d.delay.apply(d,[c,1].concat(g.call(arguments,1)))};d.throttle=function(c,a){var b,e,f,g,h,l,k=d.debounce(function(){h=g=!1},a);return function(){b=this;e=arguments;f||(f=setTimeout(function(){f=
null;h&&c.apply(b,e);k()},a));g?h=!0:l=c.apply(b,e);k();g=!0;return l}};d.debounce=function(c,a,b){var d;return function(){var e=this,f=arguments;b&&!d&&c.apply(e,f);clearTimeout(d);d=setTimeout(function(){d=null;b||c.apply(e,f)},a)}};d.once=function(c){var a=!1,b;return function(){if(a)return b;a=!0;return b=c.apply(this,arguments)}};d.wrap=function(a,b){return function(){var d=[a].concat(g.call(arguments,0));return b.apply(this,d)}};d.compose=function(){var a=arguments;return function(){for(var b=
arguments,d=a.length-1;0<=d;d--)b=[a[d].apply(this,b)];return b[0]}};d.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};d.keys=M||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],e;for(e in a)d.has(a,e)&&(b[b.length]=e);return b};d.values=function(a){return d.map(a,d.identity)};d.functions=d.methods=function(a){var b=[],e;for(e in a)d.isFunction(a[e])&&b.push(e);return b.sort()};d.extend=function(a){m(g.call(arguments,1),function(b){for(var d in b)a[d]=
b[d]});return a};d.pick=function(a){var b={};m(d.flatten(g.call(arguments,1)),function(d){d in a&&(b[d]=a[d])});return b};d.defaults=function(a){m(g.call(arguments,1),function(b){for(var d in b)null==a[d]&&(a[d]=b[d])});return a};d.clone=function(a){return!d.isObject(a)?a:d.isArray(a)?a.slice():d.extend({},a)};d.tap=function(a,b){b(a);return a};d.isEqual=function(c,b){return a(c,b,[])};d.isEmpty=function(a){if(null==a)return!0;if(d.isArray(a)||d.isString(a))return 0===a.length;for(var b in a)if(d.has(a,
...
ThreeRTT.ScaleMaterial=function(a,b,e){var f={};a=ThreeRTT.toTarget(a);b=ThreeRTT.toTarget(b);f=_.extend(f,{sampleAlignment:{type:"v2",value:new THREE.Vector2},texture:{type:"t",value:a.read()}});b.on("render",function(){var h=a,g=b,q=g.height*e/h.height,l=f.sampleAlignment.value;l.x=g.width*e/h.width;l.y=q});var h=new THREE.ShaderMaterial({uniforms:f,vertexShader:ThreeRTT.getShader("rtt-vertex-downsample"),fragmentShader:ThreeRTT.getShader("generic-fragment-texture")});h.side=THREE.DoubleSide;h.depthTest=
...
ThreeRTT.Display.prototype=_.extend(new THREE.Object3D,{make:function(){for(var a=this.n,b=this.gx,e=this.gy,f=this.targets,h=(b-1)/2,k=(e-1)/2,g=new THREE.PlaneGeometry(1,1,1,1),q=0,l=0;q<a&&l<e;++l)for(var s=0;q<a&&s<b;++s,++q){var p=new THREE.MeshBasicMaterial({color:16777215,map:ThreeRTT.toTexture(f[q]),fog:!1});p.side=THREE.DoubleSide;p=new THREE.Mesh(g,p);p.renderDepth=1E4+Math.random();this.add(p);1<b&&(p.position.x=-h+s);1<e&&(p.position.y=k-l)}}});
