...
ThreeRTT.Camera=function(b){if(b instanceof THREE.Camera)return b;b=_.extend({aspect:1,far:1E4,fov:85,near:0.01,ortho:!1,scale:1},b);if(b.ortho){var d=b.scale,e=b.aspect;return new THREE.OrthographicCamera(-d*e,d*e,-d,d,b.near,b.far)}return new THREE.PerspectiveCamera(b.fov,b.aspect,b.near,b.far)};
...
!1;g.depthWrite=!1;g.transparent=!0;g.blending=THREE.NoBlending;return g};ThreeRTT.DownsampleMaterial=function(b,d){return new ThreeRTT.ScaleMaterial(b,d,2)};ThreeRTT.UpsampleMaterial=function(b,d){return new ThreeRTT.ScaleMaterial(b,d,0.5)};
