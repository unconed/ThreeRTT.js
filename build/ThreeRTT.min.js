...
function(){var b=g.sampleStep.value;b.x=1/(d[0].width-1);b.y=1/(d[0].height-1)});b=new THREE.ShaderMaterial({uniforms:g,vertexShader:ThreeRTT.getShader("generic-vertex-screen"),fragmentShader:ThreeRTT.getShader(b||"generic-fragment-texture")});b.side=THREE.DoubleSide;return b};
