...
ThreeRTT.Stage.prototype={options:function(){return this.target.options},reset:function(){this.renderables&&_.each(this.renderables,function(a){this.scene.remove(a)}.bind(this));this.passes=[];this.renderables=[]},paint:function(a){var b=new THREE.Object3D;b.frustumCulled=!1;b.visible=!0;var c=new ThreeRTT.FragmentMaterial(this,"generic-fragment-texture"),c=this._surface(c);b.add(c);b.add(a);this.scene.add(b);this.passes.push(1);this.renderables.push(b)},iterate:function(a,b){var c=this._surface(b);
c.visible=!1;this.scene.add(c);this.passes.push(a);this.renderables.push(c);return this},fragment:function(a){this.iterate(1,a);return this},size:function(a,b){this.camera.aspect=a/b;this.target.size(a,b);return this},read:function(a){return this.target.read(a)},uniform:function(){return this.target.uniform()},render:function(){function a(b,c){b.visible=c;_.each(b.children,function(b){a(b,c)})}this.target.clear();_.each(this.passes,function(b,c){a(this.renderables[c],!0);_.loop(b,function(){this.target.render(this.scene,
this.camera)}.bind(this));a(this.renderables[c],!1)}.bind(this));return this},clear:function(){this.target.clear();return this},destroy:function(){this.target.deallocate();this.target=this.camera=this.scene=null},_surface:function(a){var b=new THREE.Mesh(new ThreeRTT.ScreenGeometry,{});b.frustumCulled=!1;b.material=a;b.renderDepth=Infinity;return b}};
...
ThreeRTT.DownsampleMaterial=function(a,b){var c={};a=ThreeRTT.toTarget(a);b=ThreeRTT.toTarget(b);c=_.extend(c,{sampleAlignment:{type:"v2",value:new THREE.Vector2},texture:{type:"t",value:0,texture:a.read()}});b.on("render",function(){var d=a,f=b,g=2*f.height/d.height,h=c.sampleAlignment.value;h.x=2*f.width/d.width;h.y=g});var d=new THREE.ShaderMaterial({uniforms:c,vertexShader:ThreeRTT.getShader("rtt-vertex-downsample"),fragmentShader:ThreeRTT.getShader("generic-fragment-texture")});d.side=THREE.DoubleSide;
d.depthTest=!1;d.depthWrite=!1;d.transparent=!0;return d};
...
ThreeRTT.Display.prototype=_.extend(new THREE.Object3D,{make:function(){for(var a=this.n,b=this.gx,c=this.gy,d=this.targets,e=(b-1)/2,f=(c-1)/2,g=new THREE.PlaneGeometry(1,1,1,1),h=0,k=0;h<a&&k<c;++k)for(var l=0;h<a&&l<b;++l,++h){var j=new THREE.MeshBasicMaterial({color:16777215,map:ThreeRTT.toTexture(d[h]),fog:!1});j.side=THREE.DoubleSide;j=new THREE.Mesh(g,j);this.add(j);1<b&&(j.position.x=-e+l);1<c&&(j.position.y=f-k)}}});
...
this._opts={renderW:a,renderH:b},c||this._stage.size(a,b),this):{width:this._options.width,height:this._options.height}},options:function(){return this._stage.options()},reset:function(){this._stage.reset();return this},paint:function(a){this._stage.paint(a);return this},iterate:function(a,b,c,d){b=b instanceof THREE.Material?b:tQuery.createFragmentMaterial(this,b,c,d);this._stage.iterate(a,b);return this},fragment:function(a,b,c){a=a instanceof THREE.Material?a:tQuery.createFragmentMaterial(this,
a,b,c);this._stage.fragment(a);return this},raytrace:function(a,b,c){a=a instanceof THREE.Material?a:tQuery.createRaytraceMaterial(this,a,b,c);this._stage.fragment(a);return this},downsample:function(a){var b=a.scale();this.scale(2*b);a.autoSize||(b=a.size(),this.size(b.width/2,b.height/2));a=tQuery.createDownsampleMaterial(a,this);this._stage.fragment(a)},read:function(a){return this._stage.read(a)},uniform:function(){return this._stage.uniform()},render:function(){this._stage.render();return this},
...
tQuery.registerStatic("createRaytraceMaterial",function(a,b,c,d){return new ThreeRTT.RaytraceMaterial(a,b,c,d)});tQuery.registerStatic("createDownsampleMaterial",function(a,b){return new ThreeRTT.DownsampleMaterial(a,b)});
