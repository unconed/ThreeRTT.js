...
a,b,c);this._stage.fragment(a);return this},raytrace:function(a,b,c){a=a instanceof THREE.Material?a:tQuery.createRaytraceMaterial(this,a,b,c);this._stage.fragment(a);return this},downsample:function(a){var b=a.scale();this.scale(2*b);a.autoSize()||(b=a.size(),this.size(b.width/2,b.height/2));a=tQuery.createDownsampleMaterial(a,this);this._stage.fragment(a);return this},read:function(a){return this._stage.read(a)},uniform:function(){return this._stage.uniform()},render:function(){this._stage.render();
