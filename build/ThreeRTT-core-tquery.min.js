...
ThreeRTT.Stage.prototype={material:function(a){return void 0!==a?(a?(this._surface||(this._surface=new THREE.Mesh(new ThreeRTT.ScreenGeometry,{}),this._surface.frustumCulled=!1,this.scene.add(this._surface)),this._surface.material=a):(this.scene.remove(this._surface),this._surface=null),this):this._surface&&this._surface.material},size:function(a,b){this.camera.aspect=a/b;this.target.size(a,b);return this},read:function(a){return this.target.read(a)},uniform:function(){return this.target.uniform()},
...
(d.cameraWorld.value=b.matrixWorld)});return new THREE.ShaderMaterial({uniforms:d,vertexShader:ThreeRTT.getShader("generic-vertex-screen"),fragmentShader:ThreeRTT.getShader(b)})};ThreeRTT.Display=function(a,b,c){c instanceof Array||(c=[c]);this.gx=a;this.gy=b;this.targets=c;this.n=c.length;THREE.Object3D.call(this);this.make()};
ThreeRTT.Display.prototype=_.extend(new THREE.Object3D,{make:function(){for(var a=this.n,b=this.gx,c=this.gy,d=this.targets,e=(b-1)/2,f=(c-1)/2,g=new THREE.PlaneGeometry(1,1,1,1),j=0,k=0;j<a&&k<c;++k)for(var l=0;j<a&&l<b;++l,++j){var h=new THREE.MeshBasicMaterial({color:16777215,map:d[j].read(),fog:!1});h.side=THREE.DoubleSide;h=new THREE.Mesh(g,h);this.add(h);1<b&&(h.position.x=-e+l);1<c&&(h.position.y=f-k)}}});
