(function(a){for(i in a)if(!window[i])throw"Error: ThreeRTT requires "+a[i];})({THREE:"Three.js"});window.ThreeRTT=window.ThreeRTT||{};ThreeRTT.getShader=function(a){var b=document.getElementById(a);return b&&b.innerText||a};_.loop=function(a,b){for(var c=0;c<a;++c)b(c)};ThreeRTT.getShader=function(a){var b=document.getElementById(a);return b&&b.innerText||a};ThreeRTT.isPowerOfTwo=function(a){return 0===(a&a-1)};
