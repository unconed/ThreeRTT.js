...
ThreeRTT.FragmentMaterial=function(a,b,c,d){c=c||{};if(c instanceof Array){var e={};_.each(c,function(a){e["texture"+(i+1)]=a});c=e}else c.constructor!=Object&&(c={texture1:c});a instanceof Array||(a=[a]);a=_.map(a,function(a){return ThreeRTT.toTarget(a)});d=_.extend(d||{},{sampleStep:{type:"v2",value:new THREE.Vector2}});_.each(c,function(a,b){d[b]={type:"t",value:ThreeRTT.toTexture(a)}});_.each(a,function(a,b){var c="texture"+(b+1);d[c]||(d[c]={type:"t",value:a.read()})});d.texture1&&!d.texture&&
(d.texture=d.texture1);a[0].on("render",function(){var b=d.sampleStep.value;b.x=1/(a[0].width-1);b.y=1/(a[0].height-1)});b=new THREE.ShaderMaterial({uniforms:d,vertexShader:ThreeRTT.getShader("generic-vertex-screen"),fragmentShader:ThreeRTT.getShader(b||"generic-fragment-texture")});b.side=THREE.DoubleSide;return b};
