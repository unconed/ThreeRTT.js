...
return this},shader:function(a,b,c,d){a=a instanceof THREE.Material?a:tQuery.createShaderMaterial(this,a,b,c,d);this._stage.fragment(a);return this},fragment:function(a,b,c){a=a instanceof THREE.Material?a:tQuery.createFragmentMaterial(this,a,b,c);this._stage.fragment(a);return this},raytrace:function(a,b,c){a=a instanceof THREE.Material?a:tQuery.createRaytraceMaterial(this,a,b,c);this._stage.fragment(a);return this},downsample:function(a){if(!a.autoSize()){var b=a.size();this._options.width=b.width;
...
tQuery.registerStatic("createRaytraceMaterial",function(a,b,c,d){return new ThreeRTT.RaytraceMaterial(a,b,c,d)});tQuery.registerStatic("createDownsampleMaterial",function(a,b){return new ThreeRTT.DownsampleMaterial(a,b)});tQuery.registerStatic("createUpsampleMaterial",function(a,b){return new ThreeRTT.UpsampleMaterial(a,b)});tQuery.registerStatic("createScaleMaterial",function(a,b,c){return new ThreeRTT.DownsampleMaterial(a,b,c)});
